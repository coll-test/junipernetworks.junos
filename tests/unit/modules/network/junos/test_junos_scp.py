...
class TestJunosScpModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_device = patch('ansible_collections.junipernetworks.junos.plugins.modules.junos_scp.get_device')
        self.get_device = self.mock_get_device.start()

        self.mock_scp = patch('ansible_collections.junipernetworks.junos.plugins.modules.junos_scp.SCP')
